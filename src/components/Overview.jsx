  ...
  return (
    <section className='w-full p-padding-sm flex flex-col gap-8'>
        ...
        <div className='w-full flex gap-2 text-white'>
            <button className='bg-primary hover:bg-primaryHvr w-1/2 h-15 rounded-xl shadow'>Add New Product</button>
            <button className='bg-secondary hover:bg-secondaryHvr w-1/2 h-15 rounded-xl shadow'>Add New Product</button>
        </div>
    </section>
  )
}
